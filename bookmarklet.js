/* Text Express 28.1.0 — carregador autossuficiente */
(() => {
  "use strict";

  const documentRef = document;
  const targetVersion = "28.1.0";
  ...
  try {
    ...
    stylesheet.href = baseUrl + "styles.css?v=28.1.0";

/* Text Express 28.3.0 — carregador autossuficiente */
(() => {
  "use strict";

  const documentRef = document;
  const targetVersion = "28.3.0";
  ...
  try {
    ...
    stylesheet.href = baseUrl + "styles.css?v=28.3.0";

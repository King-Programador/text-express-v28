/* Text Express 28.0.5 — carregador autossuficiente */
(() => {
  "use strict";

  const documentRef = document;
  const targetVersion = "28.0.5";
  ...
  try {
    ...
    stylesheet.href = baseUrl + "styles.css?v=28.0.5";
